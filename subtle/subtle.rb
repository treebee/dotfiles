...
# Original Author::  Christoph Kappel
# License:: GNU GPLv2
# see http://hg.subforge.org/subtle
#
# Customized subtle configuration
...
style :all do
  padding    1, 3, 1, 3
  background "#1a1a1a"
  font "xft:Ubuntu Mono:pixelsize=13,style=regular"
end
...
if(["donkeykong", "diddykong"].include? host) 
...
grab modkey + "-g", "chromium --enable-gl --ignore-gpu-blacklist"
...
tag "browser" do
  match "navigator|(google\-)?chrom[e|ium]|firefox|opera"
  gravity  :center
end
...
tag "chat" do
  match "skype|pidgin|ts3client_linux_amd64"
end

tag "multimedia" do
  match "spotify|vlc|mplayer"
end

# Modes
tag "stick" do
  match  "dialog|subtly|python|gtk.rb|display|xev"
  stick  true
  float  true
end
